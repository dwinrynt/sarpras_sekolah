  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../pengembalian/tampilpengembalian.php" class="nav-link">← Back</a>
      </li>
    </ul>
...
<form action="edit.php" method="POST">
        ...
        <input type="hidden" name="id_pengembalian" value="<?php echo $pel['id_pengembalian']?>"/>
        ...
        <p><label>Tanggal Pengembalian : <input type="text" name="tanggal_pengembalian" value="<?php echo $pel['tanggal_pengembalian']?>"></label></p>
