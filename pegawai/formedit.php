  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../pegawai/tampilpegawai.php" class="nav-link">← Back</a>
      </li>
    </ul>
...
<form action="edit.php" method="POST">
        ...
        <input type="hidden" name="id_pegawai" value="<?php echo $pel['id_pegawai']?>"/>
        <p><label><input type="hidden" name="id_pegawai" value="<?php echo $pel['id_pegawai']?>"></label></p>
        <p><label>Nama Pegawai : <input type="text" name="nama_pegawai" value="<?php echo $pel['nama_pegawai']?>"></label></p>
